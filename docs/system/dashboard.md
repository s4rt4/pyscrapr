...
Dari sisi implementasi, halaman ini mengkonsumsi beberapa endpoint aggregation sekaligus dan menggunakan Mantine Grid + Card components untuk layout responsif. Pada layar desktop, tile tool tersusun dalam grid 3x2; pada tablet menjadi 2x3; dan pada mobile tertumpuk vertikal satu kolom. Warna badge status konsisten dengan tema design system: hijau untuk done, merah untuk error, biru untuk running, abu-abu untuk pending, dan kuning untuk warning seperti disk space hampir penuh.
